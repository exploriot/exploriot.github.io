...
export class SummonCommand extends AdvancedCommand {
    ...
    executor = {
        "<entity_type> <world> <position> <nbt?: json>"(sender, [entity, world, position, nbt]) {
        ...
        "@p <entity_type> <position> <nbt?: json>"(player, [entity, position, nbt]) {
        ...
        "@p <entity_type> <nbt?: json>"(player, [entity, nbt]) {
