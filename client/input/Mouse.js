import {getBaseBlockSize} from "../Utils.js";
...
export function recalculateMouse() {
    Mouse.x = (Mouse.pageX - innerWidth / 2) / getBaseBlockSize() + CServer.player.x;
    Mouse.y = (-Mouse.pageY + innerHeight / 2) / getBaseBlockSize() + CServer.player.y + CServer.player.baseBB.y2 - CServer.player.baseBB.y1 - 0.5;
